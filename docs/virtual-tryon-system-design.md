...
| Admin panel         | Next.js routes inside `apps/catalogues-web`                      | Standalone Vite + React SPA (`apps/admin`) hitting `/admin/*`                                        |
...
│  │  apps/catalogues-web    │ │ apps/admin   │ │                    │    │
...
The admin panel is a **standalone Vite + React SPA** (`apps/admin`), separate from `apps/catalogues-web`. It
