...
The real ComfyUI Basic-Auth password (`admin:Niceinteractive@2026`) for VPS `38.247.186.118:8339` was committed and remains in git history even after the file was updated with a placeholder.
