...
- `pnpm --filter @aivastra/db exec tsc --noEmit -p .`, `pnpm --filter @aivastra/types exec tsc --noEmit -p .`, `pnpm --filter @aivastra/api run typecheck`, `pnpm --filter @aivastra/web run typecheck`, `pnpm --filter @aivastra/web run lint` — all clean.
