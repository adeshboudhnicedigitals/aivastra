...
**Tech Stack:** Fastify 5 + `fastify-type-provider-zod`, Drizzle ORM / PostgreSQL 16, S3-compatible storage via `@aivastra/storage`, Vitest, Vite + React for the admin panel.
