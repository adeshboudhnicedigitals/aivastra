...
pnpm test --filter @aivastra/db 2>&1 | tail -30
```
...
```bash
pnpm test --filter @aivastra/db 2>&1 | tail -20
```
...
```bash
pnpm --filter @aivastra/types build 2>&1 | tail -10
```
...
```bash
pnpm --filter @aivastra/api build 2>&1 | tail -20
```
...
```bash
pnpm --filter @aivastra/admin build 2>&1 | tail -20
```
