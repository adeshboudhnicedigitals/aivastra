...
Run: `pnpm --filter @aivastra/db exec tsc --noEmit -p .`
...
```bash
pnpm --filter @aivastra/db run generate -- --custom --name=seed_saree_mannequin_style
```
...
Run: `pnpm --filter @aivastra/storage exec tsc --noEmit -p .`
Expected: no output (clean exit).
...
Run: `pnpm --filter @aivastra/types exec tsc --noEmit -p .`
Expected: no output (clean exit).
...
Run: `pnpm --filter @aivastra/api run typecheck`
Expected: no errors.
...
Run: `pnpm --filter @aivastra/dispatcher exec tsc --noEmit -p .`
Expected: no output (clean exit).
...
Run: `pnpm --filter @aivastra/dispatcher test -- saree-mannequin`
...
Run: `pnpm --filter @aivastra/admin exec tsc --noEmit -p .`
Expected: no errors.
...
```bash
git add app/src/main/java/aivastra/nice/aivastraadmin/ApiUtils/APIConstant.kt app/src/main/java/aivastra/nice/aivastraadmin/viewmodels/MerchantCatalogModels.kt app/src/main/java/aivastra/nice/aivastraadmin/viewmodels/MerchantCatalogRepository.kt
...
```bash
git add app/src/main/java/aivastra/nice/aivastraadmin/viewmodels/ProductUploadViewModel.kt app/src/main/java/aivastra/nice/aivastraadmin/dialog/UploadPhotoDialog.kt
...
```bash
git add app/src/main/res/layout/fragment_upload_vastra.xml app/src/main/java/aivastra/nice/aivastraadmin/fragment/UploadVastraFragment.kt
