...
```bash
cd /run/media/adeshboudh/New\ Volume/PycharmProjects/aivastra_v1
...
```bash
cd /run/media/adeshboudh/New\ Volume/PycharmProjects/aivastra_v1
pnpm --filter @aivastra/admin build 2>&1 | grep -i error | head -20
```
