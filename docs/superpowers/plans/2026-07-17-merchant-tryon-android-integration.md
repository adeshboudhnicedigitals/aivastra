...
```ts
import { randomUUID } from 'node:crypto';
import { PublicUploadSessionPresignBody } from '@aivastra/types';
import type { FastifyInstance } from 'fastify';
import { z } from 'zod';
import { AppError } from '../../lib/errors.js';
import {
...
(Use the actual package name from `apps/catalogues-web/package.json` if it differs from `@aivastra/web` — check `"name"` field first with `cat apps/catalogues-web/package.json`.)
Expected: exits 0.
...
**Files:**
- Modify: `apps/virtual-tryon-mobile&kiosk_latest/app/src/main/java/aivastra/nice/interactive/ApiUtils/APICaller.kt`
...
Open `apps/virtual-tryon-mobile&kiosk_latest/app/src/main/java/aivastra/nice/interactive/ApiUtils/APICaller.kt`. Replace the full file content with:
...
Create `apps/virtual-tryon-mobile&kiosk_latest/app/src/main/java/aivastra/nice/interactive/ApiUtils/ApiErrorPresenter.kt`:
...
```bash
git add "apps/virtual-tryon-mobile&kiosk_latest/app/src/main/java/aivastra/nice/interactive/ApiUtils/APICaller.kt" "apps/virtual-tryon-mobile&kiosk_latest/app/src/main/java/aivastra/nice/interactive/ApiUtils/ApiErrorPresenter.kt"
...
**Files:**
- Modify: `apps/virtual-tryon-mobile&kiosk_latest/app/src/main/java/aivastra/nice/interactive/ApiUtils/APIConstant.kt`
...
```bash
git add "apps/virtual-tryon-mobile&kiosk_latest/app/src/main/java/aivastra/nice/interactive/ApiUtils/APIConstant.kt"
...
**Files:**
- Modify: `apps/virtual-tryon-mobile&kiosk_latest/app/src/main/java/aivastra/nice/interactive/viewmodel/category/SareeCategoryDataRepository.kt`
...
```bash
git add "apps/virtual-tryon-mobile&kiosk_latest/app/src/main/java/aivastra/nice/interactive/viewmodel/category/SareeCategoryDataRepository.kt"
...
**Files:**
- Modify: `apps/virtual-tryon-mobile&kiosk_latest/app/src/main/java/aivastra/nice/interactive/viewmodel/category/SareecategoryDataViewModel.kt`
...
```bash
git add "apps/virtual-tryon-mobile&kiosk_latest/app/src/main/java/aivastra/nice/interactive/viewmodel/category/SareecategoryDataViewModel.kt"
...
**Files:**
- Modify: `apps/virtual-tryon-mobile&kiosk_latest/app/src/main/java/aivastra/nice/interactive/activity/camera/CapturePhotoActivity.kt`
    ...
    private suspend fun downloadUploadedPhotoToCache(r2Key: String): File? {
        return try {
            val presignedGetUrl = com.example.facewixlatest.ApiUtils.APICaller.getJsonAuthed(
                ...
                aivastra.nice.interactive.utils.PrefsManager.getAccessToken(),
            )
...
```bash
git add "apps/virtual-tryon-mobile&kiosk_latest/app/src/main/java/aivastra/nice/interactive/activity/camera/CapturePhotoActivity.kt" "apps/virtual-tryon-mobile&kiosk_latest/app/src/main/java/aivastra/nice/interactive/viewmodel/category/SareecategoryDataViewModel.kt" "apps/virtual-tryon-mobile&kiosk_latest/app/src/main/java/aivastra/nice/interactive/viewmodel/category/SareeCategoryDataRepository.kt"
...
**Files:**
- Modify: `apps/virtual-tryon-mobile&kiosk_latest/app/src/main/java/aivastra/nice/interactive/activity/camera/UploadPhotoActivity.kt`
...
**Files:**
- Modify: `apps/virtual-tryon-mobile&kiosk_latest/app/src/main/java/aivastra/nice/interactive/activity/vastra/VastraTryOnActivity.kt`
...
```bash
git add "apps/virtual-tryon-mobile&kiosk_latest/app/src/main/java/aivastra/nice/interactive/activity/vastra/VastraTryOnActivity.kt"
...
**Files:**
- Modify: `apps/virtual-tryon-mobile&kiosk_latest/app/src/main/java/aivastra/nice/interactive/activity/vastra/VastraTryOnResultActivity.kt`
...
Add the import: `import aivastra.nice.interactive.utils.ViewControll` (already imported in this file — confirm before adding a duplicate).
...
```bash
git add "apps/virtual-tryon-mobile&kiosk_latest/app/src/main/java/aivastra/nice/interactive/activity/vastra/VastraTryOnResultActivity.kt" "apps/virtual-tryon-mobile&kiosk_latest/app/src/main/java/aivastra/nice/interactive/viewmodel/category/SareecategoryDataViewModel.kt"
...
**Files:**
- Modify: `apps/virtual-tryon-mobile&kiosk_latest/app/src/main/java/aivastra/nice/interactive/activity/camera/CapturePhotoActivity.kt`
- Modify: `apps/virtual-tryon-mobile&kiosk_latest/app/src/main/java/aivastra/nice/interactive/activity/vastra/VastraCategoryItemAdapter.kt`
- Modify: `apps/virtual-tryon-mobile&kiosk_latest/app/src/main/java/aivastra/nice/interactive/activity/vastra/VastraSubCategoryItemAdapter.kt`
...
```bash
git add "apps/virtual-tryon-mobile&kiosk_latest/app/src/main/java/aivastra/nice/interactive/activity/camera/CapturePhotoActivity.kt" "apps/virtual-tryon-mobile&kiosk_latest/app/src/main/java/aivastra/nice/interactive/activity/vastra/VastraCategoryItemAdapter.kt" "apps/virtual-tryon-mobile&kiosk_latest/app/src/main/java/aivastra/nice/interactive/activity/vastra/VastraSubCategoryItemAdapter.kt"
...
Point `BuildConfig.API_BASE_URL` (or whatever local `local.properties`/Gradle config already controls it — check `app/build.gradle.kts` for how `API_BASE_URL` is currently defined) at the machine running `pnpm --filter @aivastra/api dev`.
