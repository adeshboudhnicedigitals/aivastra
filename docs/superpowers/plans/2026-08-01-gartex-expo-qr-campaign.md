...
Run: `pnpm --filter @aivastra/types typecheck` (if no `typecheck` script exists in that package, run `pnpm build` from repo root and confirm no type errors from this package)
...
Run: `pnpm --filter @aivastra/api test -- signup-campaign`
...
Run: `pnpm --filter @aivastra/api test -- auth.test`
...
Run: `pnpm --filter @aivastra/api test -- google-oauth`
...
Run: `pnpm --filter @aivastra/api test -- auth`
Expected: PASS.
...
Run: `pnpm --filter @aivastra/api test -- payments-tier`
...
Run: `pnpm --filter @aivastra/api test -- signup-campaigns-admin`
