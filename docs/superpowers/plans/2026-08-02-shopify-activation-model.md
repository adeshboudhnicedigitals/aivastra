...
Run: `pnpm --filter @aivastra/api test -- shopify-activation-resolver`
...
Run: `pnpm --filter @aivastra/api test -- shopify-customer`
...
Run: `pnpm --filter @aivastra/api test -- <the test file name>`
...
Run: `pnpm --filter @aivastra/api test -- shopify-collections-sync`
...
Run: `pnpm --filter @aivastra/api test -- shopify-collections-resync-scheduler`
...
Run: `pnpm --filter @aivastra/api test -- shopify-activation-routes`
...
Run: `pnpm --filter @aivastra/shopify test -- activationTabState`
Expected: FAIL — module does not exist.
...
Run: `pnpm --filter @aivastra/shopify typecheck`
Expected: no errors.

Run: `pnpm --filter @aivastra/shopify lint`
Expected: no errors.
...
```bash
pnpm --filter @aivastra/api test -- shopify-activation-resolver shopify-products shopify-collections-sync shopify-collections-resync-scheduler shopify-activation-routes shopify-customer
