...
Run: `pnpm --filter @aivastra/web typecheck && pnpm --dir apps/api exec vitest run --config vitest.integration.config.ts test/integration/auth.test.ts -t "rejects signup without full name"`
...
Run: `pnpm --filter @aivastra/api typecheck && pnpm --filter @aivastra/web typecheck && pnpm --dir apps/api exec vitest run --config vitest.integration.config.ts test/integration/auth.test.ts test/integration/google-oauth.test.ts test/integration/credits.test.ts`
