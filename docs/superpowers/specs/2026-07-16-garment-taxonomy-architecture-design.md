...
Extends existing infrastructure (`@aivastra/observability` Prometheus registry, `@aivastra/logger` pino child-loggers) rather than introducing new observability infrastructure:
