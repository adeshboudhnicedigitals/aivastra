...
Aivastra is running a demo booth at the Gartex Expo in Delhi, Aug 6–8, 2026. A QR code at the booth will point visitors at the catalogues-web signup page. Anyone who signs up via that QR code should get two bonuses that ordinary signups don't get:
...
The QR points at `https://app.aivastra.com/register?src=gartex2026` (or whatever `code` the admin sets — see 3.5).
