...
`aivastra.com` (WordPress, outside this repo) will get "Buy Now" buttons per
credit plan. Clicking one should land the visitor on `app.aivastra.com` and
...
```
https://app.aivastra.com/pricing?plan=<slug>
```
