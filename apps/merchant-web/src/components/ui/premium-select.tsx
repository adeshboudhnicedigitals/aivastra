      ...
      >
        <span
          style={{
            ...
            color: current ? 'hsl(var(--text-primary))' : 'hsl(var(--text-tertiary))',
            ...
            return (
              ...
              <div
                ...
                style={{
                  ...
                  color: isSelected ? 'hsl(var(--accent-primary))' : 'hsl(var(--text-primary))',
                  background: isHovered ? 'hsl(var(--bg-surface-hover))' : 'transparent',
                  cursor: 'pointer',
