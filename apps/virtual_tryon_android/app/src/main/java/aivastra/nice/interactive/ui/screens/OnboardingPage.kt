...
import aivastra.nice.interactive.viewmodels.OnboardingUiState
import aivastra.nice.interactive.viewmodels.OnboardingViewModel
...
fun OnboardingPage(
    ...
    Box(modifier = modifier.fillMaxSize().background(Color.Black)) {
        ...
        Box(
            modifier = Modifier.fillMaxWidth().align(Alignment.TopCenter).padding(top = sdp(R.dimen._24sdp))
        ) {
            AppToast(
