...
fun PendingActivationPage(
    ...
    Box(modifier = modifier.fillMaxSize().background(Color.Black)) {
        ...
        Column(
            ...
            Text(
                text = "Your business details were submitted successfully. An AiVastra admin needs to activate your account before you can start using the kiosk.",
...
private fun PendingActivationPagePreview() {
    AiVastraTheme { PendingActivationPage() }
}
