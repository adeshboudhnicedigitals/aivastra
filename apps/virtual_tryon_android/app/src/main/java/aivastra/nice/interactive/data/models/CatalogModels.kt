...
data class CatalogProduct(
    ...
    @SerializedName("secondImageUrl") val secondImageUrl: String? = null,
    // Cached mannequin-drape composite for a two-input (body+pallu) product, once
    // generated by the first customer try-on of it — prefer this over imageUrl for
    // display when present, it's a truer preview than the raw body photo.
    @SerializedName("mannequinResultUrl") val mannequinResultUrl: String? = null
)
