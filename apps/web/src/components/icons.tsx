...
export const Icon = ({
  d, size = 16, color = 'currentColor', viewBox = '0 0 24 24', stroke = true, fill = false,
}: { d: Paths; size?: number; color?: string; viewBox?: string; stroke?: boolean; fill?: boolean }) => (
  <svg width={size} height={size} viewBox={viewBox} fill={fill ? color : 'none'} stroke={stroke ? color : 'none'}
...
export const LockIcon = () => <Icon d={['M19 11H5a2 2 0 00-2 2v7a2 2 0 002 2h14a2 2 0 002-2v-7a2 2 0 00-2-2z', 'M7 11V7a5 5 0 0110 0v4']} />;
export const UserIcon = () => <Icon d={['M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2', 'M12 11a4 4 0 100-8 4 4 0 000 8z']} />;
export const Eye = () => <Icon d={['M1 12s4-8 11-8 11 8 11 8', 'M1 12s4 8 11 8 11-8 11-8', 'M12 12m-3 0a3 3 0 106 0 3 3 0 10-6 0']} />;
export const EyeOff = () => <Icon d={['M17.94 17.94A10.07 10.07 0 0112 20c-7 0-11-8-11-8a18.45 18.45 0 015.06-5.94', 'M9.9 4.24A9.12 9.12 0 0112 4c7 0 11 8 11 8a18.5 18.5 0 01-2.16 3.19', 'M1 1l22 22']} />;
export const StudioIcon = () => <Icon d={['M12 20h9', 'M16.5 3.5a2.121 2.121 0 013 3L7 19l-4 1 1-4L16.5 3.5z']} size={18} />;
export const CatalogueIcon = () => <Icon d="M4 6h16M4 10h16M4 14h16M4 18h16" size={18} />;
export const AssetsIcon = () => <Icon d={['M21 16V8a2 2 0 00-1-1.73l-7-4a2 2 0 00-2 0l-7 4A2 2 0 002 8v8a2 2 0 001 1.73l7 4a2 2 0 002 0l7-4A2 2 0 0021 16z', 'M3.27 6.96L12 12.01l8.73-5.05M12 22.08V12']} size={18} />;
export const PricingIcon = () => <Icon d="M12 2a10 10 0 100 20A10 10 0 0012 2zm0 0v20M17 5H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6" size={18} />;
export const CheckIcon = ({ color = C.pink, size = 16 }: { color?: string; size?: number }) => <Icon d="M20 6L9 17l-5-5" size={size} color={color} />;
export const XIcon = ({ size = 16 }: { size?: number }) => <Icon d="M18 6L6 18M6 6l12 12" size={size} />;
export const DownloadIcon = () => <Icon d={['M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4', 'M7 10l5 5 5-5', 'M12 15V3']} />;
export const SearchIcon = () => <Icon d={['M11 19a8 8 0 100-16 8 8 0 000 16z', 'M21 21l-4.35-4.35']} />;
