...
export const SparklesIcon = ({ size = 18 }: { size?: number }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="url(#sparkles-grad)" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
    <defs>
...
export const FlagUS = ({ size = 16 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 16 16" fill="none">
    ...
    <circle cx="4" cy="4" r="0.4" fill="white" /><circle cx="5.5" cy="4" r="0.4" fill="white" />
    <circle cx="4" cy="5.5" r="0.4" fill="white" /><circle cx="5.5" cy="5.5" r="0.4" fill="white" />
...
export const FlagGB = ({ size = 16 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 16 16" fill="none">
    ...
    <path d="M2 2l5 5V2H6l-4 4zM14 2l-5 5h1l4-4V2zM2 14l5-5H6l-4 4v1zM14 14l-5-5h-1l4 4v1z" fill="white" />
