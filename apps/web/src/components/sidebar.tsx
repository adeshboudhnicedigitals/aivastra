...
export function Sidebar() {
  ...
  if (collapsed) {
    return (
      <aside className="av-sidebar av-sidebar--collapsed" onClick={() => setCollapsed(false)} style={{ cursor: 'pointer' }}>
        ...
        <button className="av-sb-icon-btn" onClick={(e) => { e.stopPropagation(); toggleTheme(); }} title={dark ? 'Light mode' : 'Dark mode'}>
          {dark ? <SunIcon /> : <MoonIcon />}
        </button>
        <button className="av-sb-icon-btn" onClick={(e) => { e.stopPropagation(); void handleSignOut(); }} title="Sign out" style={{ color: 'var(--peach)' }}>
          <SignOutIcon />
        </button>
      </aside>
    );
  ...
  return (
    <aside className="av-sidebar">
      ...
      <div className="av-sb-actions">
        <button className="av-sb-action-btn" onClick={toggleTheme} title={dark ? 'Light mode' : 'Dark mode'}>
          {dark ? <SunIcon /> : <MoonIcon />}
          <span>{dark ? 'Light mode' : 'Dark mode'}</span>
        </button>
        <button className="av-sb-action-btn av-sb-signout" onClick={handleSignOut} title="Sign out">
          <SignOutIcon />
          <span>Sign out</span>
        </button>
      </div>
