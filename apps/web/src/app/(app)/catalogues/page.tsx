          ...
          <div style={{ display: 'flex', gap: 12 }}>
                  ...
                  {GENDERS.map((g) => (
                    <div
                      ...
                      style={{
                        ...
                        cursor: 'pointer',
                        background: genderFilter === g ? 'rgba(245,92,122,0.06)' : 'transparent',
                      }}
                    >
                      {g}
                    </div>
            ...
            <div style={{ position: 'relative' }} ref={dateRef}>
              ...
              {showDateDropdown && (
                ...
                >
                  {['Today', 'Last 7 Days', 'Last 15 Days', 'Last 30 Days', 'Custom Range'].map(
                    (d) => (
                      <div
                        key={d}
                        onClick={() => {
                        ...
                        style={{
                          ...
                          cursor: 'pointer',
                          background: dateFilter === d ? 'rgba(245,92,122,0.06)' : 'transparent',
                        }}
                      >
                        {d}
                      </div>
