export const keys = {
  ...
  merchantCatalogItem: (widgetClientId: string, id: string) =>
    `merchant-catalog/${widgetClientId}/${id}/image.jpg`,
  merchantCatalogItemThumb: (widgetClientId: string, id: string) =>
    `merchant-catalog/${widgetClientId}/${id}/thumb.jpg`,
