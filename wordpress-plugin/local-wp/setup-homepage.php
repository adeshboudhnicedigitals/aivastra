...
function aivastra_first_product_image(string $categorySlug): string
{
    $posts = get_posts([
        'post_type' => 'product',
        'numberposts' => 1,
...
$menImage = aivastra_first_product_image('blazers');
$womenImage = aivastra_first_product_image('womens-hoodies');
...
<p class="has-text-align-center" style="color:#cbd5e1">Try on any garment virtually with Aivastra's AI-powered try-on, right from the product page.</p>
<!-- /wp:paragraph -->
