...
function aivastra_sideload_local_image(string $filePath, int $productId, string $title): int
{
...
function aivastra_import_one(
    ...
    $attachmentId = aivastra_sideload_local_image($filePath, $productId, $title);
